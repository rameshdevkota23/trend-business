...
?>
<!-- wp:group {"className":"new-arrivals","style":{"spacing":{"padding":{"right":"var:preset|spacing|70","left":"var:preset|spacing|70","top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|50"},"color":{"background":"#f5f7fa"}},"layout":{"type":"constrained"}} -->
...
<!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|50"},"padding":{"right":"var:preset|spacing|20","left":"var:preset|spacing|20"}}}} -->
<div class="wp-block-columns" style="padding-right:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)"><!-- wp:column {"style":{"spacing":{"padding":{"right":"var:preset|spacing|60","left":"var:preset|spacing|60"},"blockGap":"var:preset|spacing|20"}}} -->
<div class="wp-block-column" style="padding-right:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><!-- wp:image {"id":106,"width":"357px","height":"auto","sizeSlug":"full","linkDestination":"none","align":"center","style":{"border":{"radius":"14px"},"spacing":{"margin":{"bottom":"var:preset|spacing|70"}}}} -->
<figure class="wp-block-image aligncenter size-full is-resized has-custom-border" style="margin-bottom:var(--wp--preset--spacing--70)"><img src="<?php echo esc_url( get_template_directory_uri() );?>/assets/images/block.jpg" alt="" class="wp-image-106" style="border-radius:14px;width:357px;height:auto"/></figure>
<!-- /wp:image -->
...
<!-- wp:image {"id":106,"width":"384px","height":"auto","sizeSlug":"full","linkDestination":"none","align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|70"}},"border":{"radius":"14px"}}} -->
<figure class="wp-block-image aligncenter size-full is-resized has-custom-border" style="margin-top:var(--wp--preset--spacing--70)"><img src="<?php echo esc_url( get_template_directory_uri() );?>/assets/images/block.jpg" alt="" class="wp-image-106" style="border-radius:14px;width:384px;height:auto"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
