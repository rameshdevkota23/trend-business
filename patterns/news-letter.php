...
/**
 * Title: News Letter
 * Slug: trend-business-pro/news-letter
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'Join our newsletter for $10 offs', 'trend-business-pro' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Register now to get latest updates on promotions &amp; coupons.', 'trend-business-pro' ); ?> </p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
