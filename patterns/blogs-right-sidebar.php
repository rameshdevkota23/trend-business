<?php
/**
 * Title: Blogs With Right Sidebar
 * Slug: trend-business-pro/blogs-right-sidebar
...
<h2 class="wp-block-heading has-text-align-center has-x-large-font-size"><?php echo esc_html__( 'Blogs with Right Sidebar', 'trend-business-pro' ); ?></h2>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<div class="wp-block-columns sidebar-variation" style="border-style:none;border-width:0px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"verticalAlignment":"top","width":"66.66%","className":"col-content"} -->
